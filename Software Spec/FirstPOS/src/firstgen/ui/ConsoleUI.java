...
public class ConsoleUI implements SaleViewer {
	...
	// the Sale being performed
	private Sale sale;
	
	/**
	 * @param register the Register to send messages to
	 */
	...
	public void run() {
		...
		do {
			...
			Product pd = register.addItem( id, qnty);
...
//				Store.getInstance().getProductCatalog().findProduct("");
...
//		}
	...
	private void showItem(Product pd) {
